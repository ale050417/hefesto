...
export const productImages = pgTable(
  "product_images",
  {
    ...
    // Imagen por color (migración 0051, ya aplicada): en color único, la foto
    // puede asociarse a un color y la tienda salta a ella al elegirlo. NULL =
    // imagen general (sirve para todos los colores).
    color: text("color"),
  },
  (t) => [
