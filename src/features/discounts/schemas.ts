...
export const couponSchema = z
  .object({
    ...
    // A qué aplica el cupón + objetivo (producto/categoría) + cumpleaños.
    scope: z.enum(["all", "product", "category"]).optional(),
    targetId: z.preprocess(emptyToUndef, z.uuid().optional()),
    targetLabel: z.preprocess(
      emptyToUndef,
      z.string().trim().max(120).optional(),
    ),
    birthdayOnly: z.boolean().optional(),
  })
  .refine((d) => !d.scope || d.scope === "all" || !!d.targetId, {
