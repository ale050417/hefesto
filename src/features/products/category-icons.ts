// Íconos y colores de categoría (paths exactos del index).
...
export const CAT_ICON_PATHS: Record<string, string> = {
  ...
  gamepad:
    '<line x1="6" y1="12" x2="10" y2="12"/><line x1="8" y1="10" x2="8" y2="14"/><line x1="15" y1="13" x2="15.01" y2="13"/><line x1="18" y1="11" x2="18.01" y2="11"/><rect x="2" y="6" width="20" height="12" rx="6"/>',
  key: '<path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"/>',
  lamp: '<path d="M9 2h6l3 7H6l3-7zM12 9v8M8 21h8M10 17h4v4h-4z"/>',
  palette:
...
export const DEFAULT_CAT_ICON = "box";

/** Path SVG del ícono (fallback: box). */
export function catIconPath(name: string | null | undefined): string {
  return (name && CAT_ICON_PATHS[name]) || CAT_ICON_PATHS[DEFAULT_CAT_ICON]!;
}
